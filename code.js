    ...
    return function (e) {
        ...
        var o = t(0),
            ...
            r = function (e, n, t) {
                ...
                return o.classList.add("topg-component-container"), (0, i.default)(o, {
                    position: "relative",
        ...
        var r = function () {
            ...
            x = function () {
                ...
                return r(e, [{
                    ...
                    value: function () {
                        var e = this;
                        this.container = document.createElement("div"), this.container.classList.add(v["topg-container"]);
                        var n = {};
        ...
        var s = function () {
            ...
            g = function (e) {
                function n(e, o, a, s) {
                    ...
                    if (u.input = u.container.appendChild(document.createElement("input")), u.input.type = "range", u.input.className = d["topg-range"], o.label && u.input.setAttribute("aria-label", o.label + " input"), "log" === o.scale) {
        ...
        var s = t(4),
            ...
            f = function (e) {
                function n(e, o, a, s) {
                    ...
                    return l.className = c["topg-button"], l.textContent = o.label, l.addEventListener("click", o.action), l.addEventListener("mouseup", function () {
                        l.blur()
                    }), u
                }
                return a(n, e), n
        ...
        var a = function () {
            ...
            c = function (e) {
                function n(e, r, a, s) {
                    ...
                    u.opts = r;
                    var c, f, p, h, d, g, b;
                    if (u.container = t(2)(e, r.label, a), t(5)(u.container, r.label, a), u.input = document.createElement("select"), u.input.className = l["topg-select-dropdown"], r.label && u.input.setAttribute("aria-label", r.label), f = document.createElement("span"), f.classList.add(l["topg-select-triangle"], l["topg-select-triangle--down"]), p = document.createElement("span"), p.classList.add(l["topg-select-triangle"], l["topg-select-triangle--up"]), u.container.appendChild(f), u.container.appendChild(p), Array.isArray(r.options))
                    ...
                    var m = function () {
                        f.classList.add(l["topg-select-triangle--down-highlight"]), p.classList.add(l["topg-select-triangle--up-highlight"])
                    },
                        y = function () {
                            f.classList.remove(l["topg-select-triangle--down-highlight"]), p.classList.remove(l["topg-select-triangle--up-highlight"])
                        },
                        v = !1;
        ...
        var s = function () {
            ...
            p = function (e) {
                function n(e, o, a, s) {
                    i(this, n);
                    var u = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this));
                    return u.opts = o, u.container = t(2)(e, o.label, a), t(5)(u.container, o.label, a), u.input = u.container.appendChild(document.createElement("input")), u.input.type = "text", u.input.className = "topg-text", o.initial && (u.input.value = o.initial), o.label && u.input.setAttribute("aria-label", o.label), (0, f.default)(u.input, {
                        position: "absolute",
                        paddingLeft: "6px",
                        height: a.sizing.componentHeight,
        ...
        var i = function () {
            ...
            u = function () {
                function e(n, i, r, u) {
                    var l = this;
                    o(this, e), this.opts = i, this.container = t(2)(n, i.label, r), this.container.classList.add(s["topg-folder"]), this.container.setAttribute("role", "button"), this.container.setAttribute("tabIndex", "0"), this.arrow = this.container.appendChild(document.createElement("div")), this.arrow.innerHTML = "&#9662;", (0, a.default)(this.arrow, {
                        width: "1.5em"
                    ...
                    }), this.folderContainer = n.appendChild(document.createElement("div")), this.folderContainer.classList.add(s["topg-folder-contents"]), this.open = this.opts.open || !1, this.SetOpen(this.open)
                }
                return i(e, [{
                    key: "Toggle",
                    value: function () {
                    ...
                    key: "SetOpen",
                    value: function (e) {
                        this.open = e, e ? (this.folderContainer.classList.remove(s["topg-folder-closed"]), this.arrow.innerHTML = "&#9662;") : (this.folderContainer.classList.add(s["topg-folder-closed"]), this.arrow.innerHTML = "&#9656;")
                    }
                }]), e
            }();
        ...
        var s = function () {
            ...
            h = function (e) {
                function n(e, o, a, s) {
                    i(this, n);
                    var u = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this));
                    u.opts = o, u.opts.fileReadFunc = u.opts.fileReadFunc || "readAsDataURL", u.file = null, u.fileName = null, u.container = t(2)(e, o.label, a), u.container.classList.add(p["topg-file-container"]), u.container.setAttribute("role", "button"), u.container.setAttribute("tabIndex", "0"), (0, f.default)(u.container, {
                        width: "100%",
                        "box-sizing": "border-box",
                        "-moz-box-sizing": "border-box",
                        "-webkit-box-sizing": "border-box",
                    ...
                    return c.addEventListener("change", h), u.container.addEventListener("dragover", function (e) {
                        e.preventDefault(), e.stopPropagation(), u.container.classList.add(p["topg-dragover"])
                    }), u.container.addEventListener("dragleave", function (e) {
                        e.preventDefault(), e.stopPropagation(), u.container.classList.remove(p["topg-dragover"])
                    }), u.container.addEventListener("drop", function (e) {
                        e.preventDefault(), e.stopPropagation(), u.container.classList.remove(p["topg-dragover"]), h(e)
        ...
        var u = function () {
            ...
            b = function (e) {
                function n(e, o, a, u) {
                    ...
                    if (l.input = l.container.appendChild(document.createElement("span")), l.input.className = g["topg-interval"], l.handle = document.createElement("span"), l.handle.className = g["topg-interval-handle"], l.input.appendChild(l.handle), Array.isArray(o.initial) || (o.initial = []), "log" === o.scale) {
        ...
        n.MenuBar = function (e) {
            function n(e, o) {
                ...
                var a = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this)),
                    s = t(73);
                if (a.element = document.createElement("div"), a.element.className = s["topg-bar"], e.appendChild(a.element), o.title) {
                    var u = a.element.appendChild(document.createElement("div"));
                    u.className = s["topg-bar-title"], u.innerHTML = o.title
                }
                var c = a.element.appendChild(document.createElement("button"));
                if (c.className = s["topg-bar-button"], c.innerHTML = "Controls", (0, l.default)(c, {
                    ...
                    f.className = s["topg-bar-button"], f.innerHTML = "「　」", f.setAttribute("aria-label", "Toggle Fullscreen"), (0, l.default)(f, {
        ...
        n.Panel = function () {
            function e(n, i) {
                o(this, e), this.opts = i, this.styles = t(75), this.container = n.appendChild(document.createElement("div")), this.container.className = this.styles["topg-panel-container"], (0, a.default)(this.container, {
                    width: i.width,
                    opacity: i.opacity || 1,
                ...
                }), "none" === i.barMode && this._MakeToggleButton(), this.panel = this.container.appendChild(document.createElement("div")), this.panel.className = this.styles["topg-panel"], "none" === i.barMode && i.title && t(76)(this.panel, i.title, s.theme)
            }
            return i(e, [{
                key: "SetVisible",
                value: function (e) {
                    e ? (this.panel.classList.remove(this.styles["topg-panel-hidden"]), this.menuButton && this.menuButton.setAttribute("alt", "Close GUI")) : (this.panel.classList.add(this.styles["topg-panel-hidden"]), this.menuButton && this.menuButton.setAttribute("alt", "Open GUI"))
                }
            }, {
                key: "ToggleVisible",
                value: function () {
                    this.panel.classList.contains(this.styles["topg-panel-hidden"]) ? this.SetVisible(!0) : this.SetVisible(!1)
                }
            }, {
                key: "_MakeToggleButton",
                value: function () {
                    var e = this;
                    this.menuButton = this.container.appendChild(document.createElement("button")), this.menuButton.className = this.styles["topg-panel-toggle-button"], (0, a.default)(this.menuButton, {
        ...
        t(1), n.ToastArea = function () {
            function e(n, i) {
                o(this, e), this.opts = i, this.styles = t(78), this.element = n.appendChild(document.createElement("div")), this.element.classList.add(this.styles["topg-toast-area"]), (0, a.default)(this.element, {
                    position: "absolute",
                    width: "100%"
                })
            }
            return i(e, [{
                ...
                value: function (e) {
                    ...
                    o.classList.add(this.styles["topg-toast-notification"]), o.setAttribute("aria-live", "polite"), o.innerHTML = e, (0, a.default)(o, {});
                    var i = o.appendChild(document.createElement("button"));
                    i.innerHTML = "&#10006;", i.classList.add(this.styles["topg-toast-close-button"]);
                    var r = void 0,
                        s = function () {
